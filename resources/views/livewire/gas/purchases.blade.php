  ...
  <div class="mx-auto max-w-7xl space-y-4 px-4 py-6">
    ...
    @if ($recentCalls->count() > 0)
      <div class="overflow-hidden rounded-lg bg-white shadow-md">
        <div class="bg-linear-to-r border-b from-purple-100 to-pink-100 px-4 py-3">
          <h3 class="text-lg font-bold">📞 Llamadas Recientes</h3>
        </div>
          ...
          @foreach ($recentCalls as $call)
            <div class="flex items-center justify-between p-3">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-medium text-gray-900">{{ $call->supplier->name }}</p>
    ...
    <div class="overflow-hidden rounded-lg bg-white shadow-md">
      ...
      >
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <!-- Fecha de compra -->
          <div>
            <label class="mb-1 block text-sm font-medium text-gray-700">Fecha y hora de
              compra</label>
            <input
              type="datetime-local"
            ...
            @if ($supplier_id)
              ...
              @if ($selectedSupplier && $selectedSupplier->phone)
                <a
                  ...
                  wire:click="registerCall({{ $selectedSupplier->id }})"
